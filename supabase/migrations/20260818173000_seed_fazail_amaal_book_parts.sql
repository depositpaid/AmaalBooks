...
BEGIN
  ...
  VALUES
    ...
    (
      ...
      'VIRTUES OF THE HOLY QUR’AAN', 'Virtues of the Holy Qur’aan', NULL, 1,
    ...
    (
      ...
      'GLOSSARY FOR FAZA’IL-E-A’MAAL', 'Glossary for Faza’il-e-A’maal', NULL, 8,
  ...
  WITH expected (
    ...
    VALUES
      ...
      ('fb53917f-6d64-4aa1-907b-215538af024f'::uuid, v_book_id, 'part', 'VIRTUES OF THE HOLY QUR’AAN', 'Virtues of the Holy Qur’aan', NULL, 1, 269, 383, '4', '114', 'verified', 'The constituent cover says Part 3 while the combined-volume list says Part 2. The primary identifier is intentionally unresolved; both observations are preserved in book_part_source_evidence.'),
      ...
      ('9d883011-dd1e-48d0-8963-c3c1c0e1f8aa'::uuid, v_book_id, 'ancillary', 'GLOSSARY FOR FAZA’IL-E-A’MAAL', 'Glossary for Faza’il-e-A’maal', NULL, 8, 944, 958, '1', '15', 'verified', 'Verified unnumbered ancillary section; no Part identifier is invented.')
  )
  SELECT count(*)
  ...
  VALUES
    (
      ...
      NULL, 'constituent_cover', 269, 'Part 3', 'VIRTUES OF THE HOLY QUR’AAN',
      'Exact constituent-cover observation in Fazail-e-amaalComplete.pdf.'
    ),
    (
      'dde4b37b-9e8d-4284-b9a1-01bd489e15b5',
      'fb53917f-6d64-4aa1-907b-215538af024f',
      NULL, 'combined_volume_list', 385, 'Part 2', 'Virtues of The Holy Qur’aan',
  ...
  WITH expected (
    ...
    VALUES
      ('bbbc9ad0-f34f-4540-9e40-ae79780b802d'::uuid, 'fb53917f-6d64-4aa1-907b-215538af024f'::uuid, NULL::uuid, 'constituent_cover', 269, 'Part 3', 'VIRTUES OF THE HOLY QUR’AAN', 'Exact constituent-cover observation in Fazail-e-amaalComplete.pdf.'),
      ('dde4b37b-9e8d-4284-b9a1-01bd489e15b5'::uuid, 'fb53917f-6d64-4aa1-907b-215538af024f'::uuid, NULL::uuid, 'combined_volume_list', 385, 'Part 2', 'Virtues of The Holy Qur’aan', 'Exact combined-volume list observation in Fazail-e-amaalComplete.pdf; retained alongside the contradictory constituent-cover identifier.'),
