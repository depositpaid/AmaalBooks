...
page_number remains 10-15 (internal sequence within the constituent work).
printed_page_label remains 10-15. pdf_page_number remains 393-398.
...
BEGIN
  ...
  -- Hash every field except the two explicitly permitted page changes (book_id,
  -- book_part_id). page_number is NOT excluded because it must stay 10-15.
